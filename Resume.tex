...
An ongoing collection of kernels (written in the form of IPython notebooks \& scripts) designed using datasets obtained from Kaggle for practise as well as competitions. ({\href{https://github.com/sominwadhwa/Kaggle}{\underline{repository}}})
