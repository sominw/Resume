...
\section{\sc Skills}
\begin{list2}
\item {\bf Languages \& Frameworks}: Python, Java, Bash Scripting, SQL. Tensorflow, Keras, Scikit-Learn, Spacy, NLTK, Pandas, NumPy, SciPy, Matplotlib, Plotly, MongoDB, Flask 
